  ...
  return (
    <div className="w-full h-10 bgradient flex items-center justify-between my-6">
      <div className="w-7xl flex items-center mx-44 my-10 text-white text-sm pr-6">
        <div className="dropdown">
          <div className="flex items-center bg-white text-black p-1 px-2 border-b-10 rounded-t-md mb-0">
            ...
            <button className="flex items-center justify-center font-bold pl-1">
              Produse
            </button>
          </div>
        ...
        <a
          href="/"
          className="mr-4 hover-bg2 px-2 text-xs border border-2 border-transparent"
        >
          Incearca Genius
        </a>
        <a
        ...
        <a
          ...
          className="mr-4 hover-bg2 px-2 text-xs border border-2 border-transparent"
        >
          Extra-reducerile momentului
        </a>
        <a
          href="/"
          className="mr-10 hover-bg2 px-2 text-xs border border-2 border-transparent"
        >
          Tazz by eMAG
        </a>
      </div>
      <div className="flex mr-44 items-center">
        ...
        <a href="/" className="max-w-7xl flex text-white text-sm hover-bg2">
          eMAG Help
        </a>
      </div>
    </div>
